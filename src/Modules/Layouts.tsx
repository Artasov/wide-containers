...
FRST.displayName = 'FRST';

const FRCT = forwardRef<HTMLDivElement, ContainerProps>(({
                                                             children,
                                                             sx = {},
                                                             ...props
                                                         }, ref) => (
...
FRCT.displayName = 'FRCT';

const FRET = forwardRef<HTMLDivElement, ContainerProps>(({
                                                             children,
                                                             sx = {},
                                                             ...props
                                                         }, ref) => (
...
const FRBST = forwardRef<HTMLDivElement, ContainerProps>(({
                                                              children,
                                                              sx = {},
                                                              ...props
                                                          }, ref) => (
...
FRBST.displayName = 'FRBST';

const FRAST = forwardRef<HTMLDivElement, ContainerProps>(({
                                                              children,
                                                              sx = {},
                                                              ...props
                                                          }, ref) => (
...
FRAST.displayName = 'FRAST';

/* Для flex column */
const FCST = forwardRef<HTMLDivElement, ContainerProps>(({
                                                             children,
                                                             sx = {},
                                                             ...props
                                                         }, ref) => (
...
FCST.displayName = 'FCST';

const FCCST = forwardRef<HTMLDivElement, ContainerProps>(({
                                                              children,
                                                              sx = {},
                                                              ...props
                                                          }, ref) => (
...
FCCST.displayName = 'FCCST';

const FCEST = forwardRef<HTMLDivElement, ContainerProps>(({
                                                              children,
                                                              sx = {},
                                                              ...props
                                                          }, ref) => (
...
FCEST.displayName = 'FCEST';

const FCBST = forwardRef<HTMLDivElement, ContainerProps>(({
                                                              children,
                                                              sx = {},
                                                              ...props
                                                          }, ref) => (
...
FCBST.displayName = 'FCBST';

const FCAST = forwardRef<HTMLDivElement, ContainerProps>(({
                                                              children,
                                                              sx = {},
                                                              ...props
                                                          }, ref) => (
